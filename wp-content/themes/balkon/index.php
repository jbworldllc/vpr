...
if( balkon_global_var('show_blog_header') ) :?>
    <section class="parallax-section header-section" data-scrollax-parent="true">
        ...
        <div class="container big-container">
            ...
            <?php 
                if( balkon_global_var('blog_head_title_sub') ) : ?>
                <h3 class="head-sec-subtitle"><?php echo wp_kses_post( balkon_global_var('blog_head_title_sub') );?></h3>
                <div class="separator trsp-separator"></div>
            <?php endif;?>
                <h1 class="head-sec-title"><?php echo wp_kses_post( balkon_global_var('blog_head_title') );?></h1>
                <?php echo wp_kses_post( balkon_global_var('blog_head_title_desc') ); ?> 
