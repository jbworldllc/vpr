...
<div class="content">
    ...
    <section id="sec1">
        <div class="container">
            <div class="row">
                <?php if( balkon_global_var('blog_layout') ==='left_sidebar' && is_active_sidebar('sidebar-2')):?>
                ...
                <?php endif;?>
                <?php if( balkon_global_var('blog_layout') ==='fullwidth' ||  !is_active_sidebar('sidebar-2')):?>
                     
                <div class="col-md-12 display-page nosidebar post-container">
                <?php else:?>
                 
                <div class="col-md-<?php echo (12 - $sb_w);?> display-page hassidebar post-container">
                <?php endif;?>
                ...
                <?php if( balkon_global_var('blog_layout') ==='right_sidebar' && is_active_sidebar('sidebar-2')):?>
                <div class="col-md-<?php echo esc_attr($sb_w );?> blog-sidebar-column">
