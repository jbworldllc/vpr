...
<?php
$css_classes = array(
    'archive-portfolio-parallax-style-wrap folio-parallax-main-wrap',
);
...
<section class="<?php echo esc_attr($css_class );?>" id="sec1">
    ...
    ?>
    <div class="folio-parallax-filter-wrap">
    ...
    if(balkon_global_var('folio_enable_gallery'))
    ...
    <div class="folio-grid-folios-wrap fogrid-<?php echo esc_attr( balkon_global_var('folio_grid_content_width') );?>">
            ...
            <?php endif;?>>
                ...
                <?php $pin = 1; while($folio_posts->have_posts()) : $folio_posts->the_post(); ?>
                    <?php 
                    balkon_get_template_part( 'portfolio', 'parallax' , array( 'pin'=>$pin ));
                    ?>
    ...
    <div class="partcile-dec" data-count="250" data-color="#ccc"></div>
</section>
<?php endif;?>
