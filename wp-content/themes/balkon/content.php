...
?>
<div <?php post_class('content-content fl-wrap fw-post');?>>
    ...
    if( !empty($slider_images)&& balkon_global_var('blog_list_show_format') && get_post_format( ) !== 'gallery' ){ ?>
		...
		<div class="single-slider fl-wrap" data-effects="slide">
            <div class="swiper-container">
                ...
                foreach ( (array) $slider_images as $img_id => $img_url ) {
			        ...
			        echo wp_get_attachment_image($img_id, 'balkon_blog_thumb','',array('class'=>'respimg') );
			        echo '</div>';
			    }
				?>
                </div>
