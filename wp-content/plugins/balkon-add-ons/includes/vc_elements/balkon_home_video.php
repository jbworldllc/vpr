<?php 
vc_map( array(
        "name"                      => esc_html__("Home Hosted Video", 'balkon-add-ons'),
        "base"                      => "balkon_home_video",
        "content_element"           => true,
        "icon"                      => CTH_DIR_URL . "assets/cththemes-logo.png",
        ////"html_template"             => CTH_ABSPATH.'/vc_templates/balkon_home_video.php',
...
<div><a href="#sec2" class="btn float-btn flat-btn custom-scroll-link">Let\'s Start</a></div>'
            ...
            array(
                "type"          => "textfield",
                "heading"       => esc_html__("Your Video URL", 'balkon-add-ons'),
                "param_name"    => "video",
                "value"         => esc_url( home_url( '/wp-content/uploads/2017/07/intro.mp4' ) ),
                "description"   => esc_html__("Your video file have to be in .mp4 format.", 'balkon-add-ons')
            ),
            array(
                "type"          => "dropdown",
    ...
    if ( class_exists( 'WPBakeryShortCode' ) ) {
        class WPBakeryShortCode_Balkon_Home_Video extends WPBakeryShortCode {     
        }
    }
