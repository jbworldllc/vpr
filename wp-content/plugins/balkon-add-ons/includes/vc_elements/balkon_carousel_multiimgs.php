<?php 
    ...
    vc_map( array(
        ...
        "base"                      => "balkon_carousel_multiimgs",
        "category"                  => 'Balkon Theme',
        "content_element"           => true,
        "show_settings_on_create"   => true,
        "icon"                      => CTH_DIR_URL . "assets/cththemes-logo.png",
        ////"html_template"             => CTH_ABSPATH.'/vc_templates/balkon_carousel_multiimgs.php',
        "params"                    => array(
            array(
                "type"          => "attach_images",
                "holder"        => "div",
    ...
    if ( class_exists( 'WPBakeryShortCode' ) ) {
        class WPBakeryShortCode_Balkon_Carousel_Multiimgs extends WPBakeryShortCode {}
    }
