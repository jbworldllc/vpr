<?php
vc_map( array(
            "name"                      => esc_html__("Portfolio Title", 'balkon-add-ons'),
            "base"                      => "balkon_portfolio_title",
            "icon"                      => CTH_DIR_URL . "assets/cththemes-logo.png",
            //"html_template"             => CTH_ABSPATH.'/vc_templates/balkon_portfolio_title.php',
        ...
        if ( class_exists( 'WPBakeryShortCode' ) ) {
            class WPBakeryShortCode_Balkon_Portfolio_Title extends WPBakeryShortCode {}
        }