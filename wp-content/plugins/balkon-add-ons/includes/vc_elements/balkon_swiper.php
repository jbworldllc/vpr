<?php 
vc_map( array(
        "name"                      => esc_html__("Home Slider", 'balkon-add-ons'),
        "description"               => esc_html__("Home Page Slider using swiper plugin",'balkon-add-ons'),
        "base"                      => "balkon_swiper",
        "category"                  => 'Balkon Theme',
        "as_parent"                 => array('only' => 'balkon_swiper_item'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
        "content_element"           => true,
        "show_settings_on_create"   => false,
        "icon"                      => CTH_DIR_URL . "assets/cththemes-logo.png",
        ////"html_template"             => CTH_ABSPATH.'/vc_templates/balkon_swiper.php',
        "params"                    => array(
            array(
                "type"          => "textfield",
    ...
    vc_map( array(
        ...
        "base"                      => "balkon_swiper_item",
        "content_element"           => true,
        "icon"                      => CTH_DIR_URL . "assets/cththemes-logo.png",
        ////"html_template"             => CTH_ABSPATH.'/vc_templates/balkon_swiper_item.php',
        "as_child"                  => array('only' => 'balkon_swiper'),
        "params"                    => array(
            array(
                "type"          => "attach_image",
                "holder"        => "div",
...
<div><a href="'.esc_url( home_url('/portfolio/' )).'" class="btn float-btn flat-btn">Our portfolio</a></div>'
    ...
    if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
        class WPBakeryShortCode_Balkon_Swiper extends WPBakeryShortCodesContainer {}
    }
    if ( class_exists( 'WPBakeryShortCode' ) ) {
        class WPBakeryShortCode_Balkon_Swiper_Item extends WPBakeryShortCode {     
        }
    }