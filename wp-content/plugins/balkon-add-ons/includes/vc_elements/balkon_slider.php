<?php
vc_map( array(
            "name" => esc_html__("Images Slider", 'balkon-add-ons'),
            ...
            //"html_template"             => CTH_ABSPATH.'/vc_templates/balkon_slider.php',
            "params" => array(
                array(
                    "type"          => "attach_images",
                    "holder"        => "div",
        ...
        if ( class_exists( 'WPBakeryShortCode' ) ) {
            class WPBakeryShortCode_Balkon_Slider extends WPBakeryShortCode {}
        }
