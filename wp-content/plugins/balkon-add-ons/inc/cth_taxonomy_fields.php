...
if(!function_exists('balkon_select_media_file_field')){
 	function balkon_select_media_file_field($f_id = 'cat_header_image',$f_title = 'Header Background Image', $term_values = array(),$new_screen = true){
 		if($new_screen){
...
if(!function_exists('balkon_radio_options_field')){
	/**
	* field_options : array('id','name','desc','values','default')
	*
	*/
 	function balkon_radio_options_field($field_options, $term_values = array(),$new_screen = true){
